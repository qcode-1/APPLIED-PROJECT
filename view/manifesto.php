...
<head>
	...
	echo $_SESSION['user'];?> - Manifesto Page</title>
</head>
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-8">
				<h2 class="cand" style="text-align: center;">Manifesto for Edwin</h2>
			...
			<div class="col-12">
				...
				<span>
					...
					<p>Carol and I have been made aware of the continuous and unabating work load that is being placed on the Ashesi student on a daily basis. To address this problem and help the Ashesi student to manage this work load, Carol and I have come up with two solutions for this problem. They are:
					...
					<p>We hope that as you have read through our policies you are now convinced that we are indeed the best pair for the job. Just imagine all of the wonderful things that you will be missing out on if you don't vote us into power. 
			...
			<div class="col-8">
				...
				<form method="POST" action="">
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="commnt" id="exampleFormControlTextarea1" rows="3"></textarea>
					</div>
					<button type="submit" name="addComment" class="btn btn-primary mb-2">Add Comment</button>
