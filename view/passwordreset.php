...
<body>
	...
	$_SESSION['emailadd'] = $_POST['eml'];

	//require_once("mailer/passwordmailer.php");
		...
		<div class="row">
			...
			<div class="col-6">
				...
				<form method="POST">
					...
					<button type="submit button" class="btn btn-primary" data-toggle="modal" name="changePass" class="btn btn-primary">Send Email</button>
				</form>
